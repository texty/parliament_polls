(function() {
    ...
    var candidates_1_checked = ["Слуга__народу", "Опозиційна__платформа",
        "Європейська__солідарність", "Батьківщина", "Голос____Вакарчук____", "Не__визначились"];

    var candidates_1_unchecked = ["Сила__і__Честь", "Не__піду__на__вибори"];



    var candidates_3_checked = ["Слуга__народу", "Опозиційна__платформа",
            "Європейська__солідарність", "Батьківщина", "Голос____Вакарчук____"];

    var candidates_3_unchecked = ["Сила__і__Честь"];
    ...
    function drawChart(chart) {
        ...
        d3.select("#main_chart_vertical").selectAll("canvas").remove();
